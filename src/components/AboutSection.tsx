...
const AboutSection: React.FC = () => {
  ...
  return <section className="bg-white py-16 md:py-20">
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* RIGHT — Text & Features */}
        <div>
          <p className="uppercase tracking-wide font-extrabold text-3xl" style={{
          color: ACCENT
        }}>
            ABOUT US
          </p>
          ...
          <p className="mt-5 text-gray-700 max-w-xl">
            <strong>Haixun Global Shenzhen</strong>, leverages over 30 years of expertise in logistics, including sea, land,
            air transportation, customs declaration, warehousing, and distribution. The Group has expanded its network to
            regions such as <strong>China, India, Malaysia, the UAE</strong>, and beyond.
          </p>

          <p className="mt-5 text-gray-700 max-w-xl">
            Established in <strong>2019</strong>, Haixun Global Shenzhen upholds the Group’s commitment to integrity, customer
            satisfaction, and rapid response, ensuring a reliable and customer‑focused service experience in China.
          </p>
          ...
          {/* CTA + Contact (includes Established in 2019 before phone) */}
