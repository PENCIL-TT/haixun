...
const AboutUs = () => {
  ...
  const sliderImages = ["/Dubai.jpg", "/jebelali1.png", "/burj-khalifa.jpg"]; // no longer used visually but kept if needed later
            ...
            <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white px-8 py-10 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Services offered: cargo loading, lashing, surveyor
                    coordination and inter-island movement to main ports for OOG
                    cargo...
                  </p>
                </div>
                <Link
