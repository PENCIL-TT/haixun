      ...
      <main className="flex-grow pt-0">
        ...
        <section className="relative h-[380px] w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="relative text-center text-white">
            <p className="text-red-400 font-semibold tracking-wide mb-2">
              About Us
            </p>
        ...
        {/* REST OF YOUR PAGE (unchanged content) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <div className="absolute -bottom-10 left-10 bg-kargon-red text-white rounded-3xl px-8 py-5 shadow-xl">
              ...
              >
                <p className="text-sm font-semibold text-kargon-red uppercase tracking-wide">
                  {t("about.whoWeAre")}
                </p>
                ...
                <p className="text-sm md:text-base text-gray-700">{t("about.paragraph1")}</p>
                <p className="text-sm md:text-base text-gray-700">{t("about.paragraph2")}</p>
                <p className="text-sm md:text-base text-gray-700">{t("about.paragraph3")}</p>

                <Link to="/contact">
                  <Button className="bg-kargon-red hover:bg-kargon-red/90 text-white px-7 py-5 text-sm rounded-full">
                    {t("nav.contact")}
                  </Button>
                </Link>
              </motion.div>
        ...
        <section className="py-24 bg-white relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-center text-4xl font-bold text-kargon-red mb-14">
              Our Core Services
            </h2>
            ...
            <div className="flex justify-center gap-10 flex-wrap">
              ...
              <div className="w-full sm:w-[360px]">
                <div className="bg-kargon-red rounded-3xl px-8 py-10 shadow-xl text-center">
                  <div className="w-16 h-16 rounded-full bg-white/15 flex items-center justify-center mx-auto mb-2">
