              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    Amass Freight, Dubai is one of the leading logistics
                    providers in the region providing Less-Than Container load
                    (LCL) for the ultimate convenience of our customers to help
                    in transporting their products to any location required.
                  </p>
                  <p className="text-lg leading-relaxed text-gray-700">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    ...
                    to worry about deadlines when using our ocean freight
                    services, as we are committed to getting your cargo to its
                    desired destination on time safely.
                  </p>
                </div>
              </motion.div>
